...
import (
	...
	"github.com/jintoples/restaurant-management/models"
...
func GetOrderItems() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured when listing orderItem"})
		}
...
func GetOrderItemsByOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured when listing order item by order id"})
			return
		}
...
func GetOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured when fetching orderItem"})
		}
...
func CreateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		result, insertErr := orderItemCollection.InsertMany(ctx, orderItemToBeInserted)
		if insertErr != nil {
			log.Fatal(insertErr)
		}
		defer cancel()
...
func UpdateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if orderItem.Unit_price != nil {
			updateObj = append(updateObj, bson.E{"category", *&orderItem.Unit_price})
		}

		if orderItem.Quantitiy != nil {
			updateObj = append(updateObj, bson.E{"category", *orderItem.Quantitiy})
		}

		if orderItem.Food_id != nil {
			updateObj = append(updateObj, bson.E{"category", *orderItem.Food_id})
		}
